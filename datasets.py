...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        if self.video_flag[self.count]:
            ...
            height *=2
            width *=2
            img0 = cv2.resize(img0, (width,height), interpolation = cv2.INTER_CUBIC)
            img0 = img0[600:-600][900:-900]
            #img0 = img0[int(0.3*height):-int(0.3*height)][int(0.3*width):-int(0.3*width)]
            self.frame += 1
